      ...
      <section className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-24 text-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 flex items-center justify-center">
          <div className="relative">
            <img
              ...
              className="w-[1400px] h-[1400px] object-contain opacity-40 mix-blend-overlay brightness-150 contrast-175"
            />
          </div>
        </div>
        ...
        <div className="relative z-10">
          ...
          <p className="text-lg md:text-xl text-gray-400 font-light mb-12 max-w-3xl mx-auto leading-relaxed px-4">
            <span className="text-white font-bold">As</span> <span className="text-red-500 font-bold">classical cryptography collapses</span>, <span className="text-white font-bold">QubitCoin</span> <span className="text-white font-bold">builds</span> <span className="text-[#00ff9d] font-medium">Europe's digital bunker</span>.
          </p>
